    ...
    <div className="min-h-screen w-full relative bg-black">
      ...
      >
        <a
          ...
          href="/"
        >
          <div className="text-white font-bold text-xl">CodExplainr</div>
        </a>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href="/waitlist"
            className="rounded-md font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center bg-gradient-to-b from-[#e78a53] to-[#e78a53]/80 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset] px-4 py-2 text-sm"
          >
            Join Waitlist
          </a>
        </div>
      ...
      <header className="sticky top-4 z-[9999] mx-4 flex w-auto flex-row items-center justify-between rounded-full bg-background/80 backdrop-blur-sm border border-border/50 shadow-lg md:hidden px-4 py-3">
        <a
          ...
          href="/"
        >
          <div className="text-white font-bold text-lg">CodExplainr</div>
        </a>
