...
const pricingPlans = [
  {
    ...
    features: [
      "Parse up to 5 codebases per month",
  ...
  },
  {
    ...
    introductoryPrice: 3,
    annualPrice: 4,
    description: "For serious learners and job seekers",
    features: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
            Start free with essential features. Upgrade to unlock unlimited access and advanced tools for your learning journey.
          </p>
                  ...
                  {plan.price ? (
                    ...
                    <>
                      <div className="flex items-baseline justify-center gap-1">
                        {plan.introductoryPrice && !isAnnual && (
                          <>
                      ...
                      {plan.introductoryPrice && !isAnnual && (
                        <span className="text-xs text-[#e78a53] font-medium">
                          First month only, then ${plan.monthlyPrice}/month
                        </span>
                      )}
                    </>
                  )}
