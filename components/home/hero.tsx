        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                Understand Code <strong>Like Never</strong> <br />
                <strong>Before</strong> <em className="italic">With AI</em>
              </h1>
            </motion.div>
            ...
            >
              Turn complex code into simple explanations, visual flow diagrams, and interview-ready insights. Perfect for students, job seekers, and developers who want to truly master their craft.
            </motion.p>
            ...
            >
              ...
              <Link href="/waitlist" prefetch={false}>
                <div className="group cursor-pointer border border-border bg-card gap-2 h-[60px] flex items-center p-[10px] rounded-full hover:shadow-lg transition-all duration-300">
                  <div className="border border-border bg-[#e78a53] h-[40px] rounded-full flex items-center justify-center text-white">
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Built with industry-leading tools</p>
